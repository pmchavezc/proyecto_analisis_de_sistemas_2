...
export default function RequestsTable({
  ...
  return (
      <div className="bg-white rounded-xl shadow-sm overflow-hidden">
        <div className={maxHeight ? `overflow-x-auto overflow-y-auto` : 'overflow-x-auto'}>
            ...
            {requests.map((item) => (
                <tr key={item.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 text-center">
                    <ActionMenu item={item} onProgramRequest={onProgramRequest} handleNavigateToFinancing={handleNavigateToFinancing} />
                  </td>
                </tr>
            ))}
            </tbody>
